...
namespace zadanie7
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            AddStudent("1567", "Романов Виссарион Викторович", "11.08.2000", "ISIP");
            AddStudent("1668", "Логинов Захар Пантелеймонович", "23.11.2002", "ASAP");
            AddStudent("2208", "Галганов Алексей Геннадьевич", "07.02.1998", "ACAB");
